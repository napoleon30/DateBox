...
public class APDeviceActivity extends Activity implements View.OnClickListener {
    ...
    private void initSpinnerView() {
        ...
        useableSsidList = new ArrayList<String>();
        ...
        firstAdapter = new ArrayAdapter<String>(this, R.layout.spinner_text, allSsidList);
        secondAdapter = new ArrayAdapter<String>(this, R.layout.spinner_text, useableSsidList);
